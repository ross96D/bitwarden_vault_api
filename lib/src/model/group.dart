...
class Group {
  ...
  bool operator ==(Object other) => identical(this, other) || other is Group &&
    ...
    other.hidePasswords == hidePasswords;
  ...
  int get hashCode =>
    ...
    (hidePasswords == null ? 0 : hidePasswords!.hashCode);

  @override
  String toString() => 'Group[id=$id, readOnly=$readOnly, hidePasswords=$hidePasswords]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.hidePasswords != null) {
      json[r'hidePasswords'] = this.hidePasswords;
    } else {
      json[r'hidePasswords'] = null;
    }
    return json;
  }
  ...
  static Group? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Group(
        ...
        hidePasswords: mapValueOfType<bool>(json, r'hidePasswords'),
      );
    }
    return null;
  }
